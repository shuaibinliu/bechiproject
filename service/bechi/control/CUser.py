...
class CUser(SUser):
    ...
    def _create_qrcode(self, head, usid, url):
        ...
        # url = bechi_SUBSCRIBE if app_from and  in bechi_SUBSCRIBE else bechi_SERVICE
    ...
    def get_identifyinginfo(self):
        ...
        if admin_info and user.USlevel == 2:
            ...
            user.fill('manager_address', bechi_SERVICE)
    ...
    def get_agent_center(self):
        ...
        activity_count = 2
        # 佣金比例
        # commisision_profit = agent.USCommission or ConfigSettings().get_item('commission', "bechicommision")
    ...
    def get_wxconfig(self):
        ...
        # todo 根据不同的来源处理不同的mp
        if app_from and app_from in bechi_SUBSCRIBE:
