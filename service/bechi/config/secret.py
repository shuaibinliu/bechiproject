...
# db
database = env.get('BECHI_DB_NAME', "BECHI")
host = env.get('BECHI_DB_HOST', "127.0.0.1")
port = "3306"
username = env.get('BECHI_DB_USER', '')
password = env.get('BECHI_DB_PWD', 'password')
charset = "utf8mb4"
...
# 微信公众号的配置
SERVICE_APPID = env.get('BECHISERVICE_APPID', 'wxe8e8f6b9351d3587')
SERVICE_APPSECRET = env.get('BECHISERVICE_APPSECRET', 'b89e22f046d33b39c7a4afa485e661dc')

SUBSCRIBE_APPID = env.get('BECHISERVICE_APPID', 'wxe8e8f6b9351d3587')
SUBSCRIBE_APPSECRET = env.get('BECHISERVICE_APPSECRET', 'b89e22f046d33b39c7a4afa485e661dc')
